...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <div
          className="flex flex-row items-center py-[6px] px-4 bg- 
          discount-gradient
         rounded-[10px] mb-2"
        >
          <img
        ...
        <div
          className="flex flex-row justify-between items-center w- 
          full"
        >
          <h1
         ...
         text-[52px] text-white ss:leading-[100px] leading-[75px]"
          ...
          <div className="ss:flex hidden md:mr mr-0 ml-40">
            <GetStarted />
          </div>
        </div>
        <h1
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-[5] text-white`}>
          every time you pay your credit card bills on Hoobank, you 
          receive cashback coins. you can use these to win exclusive 
          rewards or get special access to curated products and 
          experiences. on Hoobank, good begets good.
        </p>
      </div>


<div className={`flex-1 flex ${styles.flexCenter} md:my-10 relative`} >
<img src={robot} alt="billing" srcset="" className="w-[100%] h-[100%] relative z-[5]" />
